...
// ============================================
// GLOBAL MODAL SYSTEM (Super Stable)
// ============================================
...
function openCaseStudy(btn) {
    const title = btn.closest('.project-card').querySelector('.project-card__title').innerText;
    const data = caseStudies[title];
    if (data) {
        const modal = document.getElementById('global-modal');
...
function openBlogPost(btn) {
    const title = btn.closest('.blog-card').querySelector('.blog-card__title').innerText;
    const data = blogPosts[title];
    if (data) {
        const modal = document.getElementById('global-modal');
        const body = document.getElementById('modal-body');
...
// Attach close event globally
document.addEventListener('DOMContentLoaded', () => {
    const closeBtn = document.getElementById('close-modal');
    if(closeBtn) closeBtn.onclick = closeGlobalModal;
